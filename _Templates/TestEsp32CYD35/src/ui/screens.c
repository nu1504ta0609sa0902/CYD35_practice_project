...
void create_screen_main()
{
  ...
  lv_obj_set_size(obj, 320, 240);
  {
    lv_obj_t *parent_obj = obj;
    {
      ...
      lv_label_set_text(obj, "Template Animation Cartoon.");
...
/// @brief
/// @param obj                      //Apply animation to this UI element
/// @param startSize                //Start size of the element
/// @param endSize                  //End size of the element at the end of the animation
/// @param duration                 //Total time for it to resize/move
/// @param pauseAtTheEnd            //Pause at the end before returning to original position
/// @param revertBackDuration       //Time to revert back to original position
/// @param delayBeforeRunningAgain  //Pause before animation starts/repeats again
/// @param startX                   //Animation will start at X position
/// @param endX                     //Animation will finish at X position
