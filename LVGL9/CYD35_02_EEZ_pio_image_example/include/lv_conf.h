...
#define LV_USE_STDLIB_SPRINTF   LV_STDLIB_BUILTIN
    ...
    #define LV_MEM_SIZE (94 * 1024U)          /*[bytes]*/
...
#if LV_USE_FS_STDIO
    #define LV_FS_STDIO_LETTER 'B'     /*Set an upper cased letter on which the drive will accessible (e.g. 'A')*/
    #define LV_FS_STDIO_PATH ""         /*Set the working directory. File/directory paths will be appended to it.*/
    #define LV_FS_STDIO_CACHE_SIZE 100000    /*>0 to cache this number of bytes in lv_fs_read()*/
#endif

/*API for open, read, etc*/
#define LV_USE_FS_POSIX 0
#if LV_USE_FS_POSIX
    #define LV_FS_POSIX_LETTER 'B'     /*Set an upper cased letter on which the drive will accessible (e.g. 'A')*/
    #define LV_FS_POSIX_PATH ""         /*Set the working directory. File/directory paths will be appended to it.*/
    #define LV_FS_POSIX_CACHE_SIZE 100000    /*>0 to cache this number of bytes in lv_fs_read()*/
#endif
...
#define LV_USE_FS_FATFS 1
    ...
    #define FF_DIR DIR
    #define LV_FS_FATFS_LETTER 'B'     /*Works on CYD35 not CYD Set an upper cased letter on which the drive will accessible (e.g. 'A')*/
    #define LV_FS_FATFS_CACHE_SIZE 0    /*>6660 to cache this number of bytes in lv_fs_read()*/
#endif
